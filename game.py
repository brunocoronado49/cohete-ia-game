...
class Game:
    ...
    def render(self):
        ...
        display_core = round(self.score / 1000)
        text_score = self.font.render("Score: " + str(display_core), True, (255, 255, 255))
        ...
        if image is not None:
            ...
            if results.multi_face_landmarks is not None:
                 for face_landmarks in results.multi_face_landmarks:
                     ...
                     self.detected_head_movement(top, bottom)
                     
            k = cv2.waitKey(1) & 0xFF
    
    def detected_head_movement(self, top, bottom):
